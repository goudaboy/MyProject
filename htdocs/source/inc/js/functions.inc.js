...
var validationTypes = {
	...
	Zipcode : function(){
		...
		var result = !this.value.match(/^([0-9]{4}[A-Z]{2})$/) ? true /* Valid Zipcode */ :  false; /* Invalid Zipcode */
		return result;
	...
	Email : function(){
		...
		var result = !inputValueReg.test(this.value) ? false /* Invalid Email address */  : true; /* Valid Email address */ 
